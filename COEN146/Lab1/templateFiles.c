/*	# Name: Xavier 
	...
	# functions such as fread(), fwrite(), and system calls such as read(), write(). The output of
	# are the respective times for each process.
*/
...
int syscall_copy(char* src_filename, char* dst_filename)  {
	...
	FILE *src_fd = open(src_filename, O_RDONLY);	// opens a file for reading
	...
	FILE *dst_fd = open(dst_filename, O_WRONLY | O_CREAT | O_TRUNC);	
