...
namespace coen79_lab8
{
    ...
    public:
        ...
        // CONSTRUCTOR
        deque_iterator( value_type**    initial_block_pointers = NULL, 
                        value_type**    initial_block_pointers_end = NULL,
                        value_type**    initial_first_bp = NULL, 
                        value_type**    initial_last_bp = NULL,
                        value_type*     initial_front_ptr = NULL, 
                        value_type*     initial_back_ptr = NULL,
                        size_type       initial_bp_array_size = 0, 
                        size_type       initial_block_size = 0,
                        value_type*     initial_cursor = NULL, 
                        value_type*     initial_current_boundary = NULL, 
        ...
        deque_iterator& operator ++( ) // Prefix ++
        {
            ...
            else if (cursor == current_boundary) {
    ...
    private:
        value_type** block_pointers; // A pointer to the dynamic array of block pointers
        value_type**  block_pointers_end; // A pointer to the final entry in the array of block pointers
        value_type**  first_bp; // A pointer to the first block pointer that’s now being used
        value_type**  last_bp; // A pointer to the last block pointer that’s now being used
